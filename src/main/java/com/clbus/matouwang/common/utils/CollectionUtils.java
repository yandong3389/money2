package com.clbus.matouwang.common.utils;
            ...
            public int compare(Object r1, Object r2) {
                ...
                try {
                    ...
                    if (String.class.getSimpleName().equals(propertyType)) {
                        if (DESC == order) {
                            result = (StringUtil.parseString(method.invoke(r2))).compareTo(StringUtil
                                    .parseString(method.invoke(r1)));
                        }
                        else {
                            result = (StringUtil.parseString(method.invoke(r1))).compareTo(StringUtil
